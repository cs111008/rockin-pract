...
import { CrudTableDemo, AdvTableDemo } from './demos';
  ...
  render() {
    ...
    return (
      <div>
        ...
        <PapperBlock title="Advancev CRUD Table" desc="The CRUD Table supports editing features including creating, updating and deleting rows. The editing state contains information about rows currently being edited, changes applied to a particular row, and rows that have been deleted and created.">
          <div>
            <Paper className={classes.root}>
              <AdvTableDemo />
            </Paper>
