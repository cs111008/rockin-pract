...
import OffersPage from './Pages/StoreAdmin/Offers';
    ...
    routes: [
      ...
      },
      {
        ...
        routes: [
          {
            path: '/app',
            component: withTracker(StoreAdmin),
            exact: true,
          },
          {
          ...
          {
            path: '/app/offers',
            component: withTracker(OffersPage),
            exact: true,
          },
          {
            path: '/app/super-admin',
            component: withTracker(SuperAdmin),
            exact: true,
          },
          // {
          //   path: '/app/dashboard-v1',
